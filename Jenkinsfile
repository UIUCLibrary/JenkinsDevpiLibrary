...
library identifier: 'DevPi', retriever: modernSCM([$class: 'GitSCMSource', credentialsId: '', id: '0db438ef-5a98-459e-ad7c-0fda6048ee2c', remote: 'https://github.com/UIUCLibrary/JenkinsDevpiLibrary.git', traits: [[$class: 'jenkins.plugins.git.traits.BranchDiscoveryTrait'], [$class: 'LocalBranchTrait']]])
